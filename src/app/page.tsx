            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span className="text-gray-700">Community Managed</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700">Digital Tracking</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <div className="text-xs text-gray-600">Available Payout</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
...
function AdminFeaturesSection() {
  ...
  return (
    <section id="admin-features" className="py-20 bg-white">
      <div className="container-responsive">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
...
function IndiaFeaturesSection() {
  ...
  return (
    <section id="india-features" className="py-20 bg-white">
      <div className="container-responsive">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
